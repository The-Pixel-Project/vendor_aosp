...
custom_local_manifest = ".repo/local_manifests/snippets/custom.xml"
...
org_display = "ThePixelProject"  # needed for displaying

default_manifest = ".repo/manifests/default.xml"
custom_manifest = ".repo/manifests/snippets/custom.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    customm = load_manifest(custom_manifest)
    ...
    for repo in repos:
        ...
        if exists_in_tree(customm, repo_path) != None:
            existing_m_project = exists_in_tree(customm, repo_path)
